...
class install
{
    ...
    static function head()
    {
       ...
       echo '<link rel="stylesheet" type="text/css" href="systemstyle.css" />';
       echo '</head>';
       echo '<body>';
       echo '<div class="body">';
       echo '<div class="header">';
       echo '<table width="100%"><tr><td width="42px">';
       echo '<img src="'.$theme.'/logo.png" />';
       echo '</td><td>';
     ...
     static function fin()
     {
       global $microtime;  
       echo '
        <div class="down"><img src="wiki_banner.png" /></div><table cellspaсing="0" cellpadding="0" style="width: 100%; border: 0px"><tr><td><a href="http://wikimobile.su"><small>&copy; WikiMobile</small></a></td>
